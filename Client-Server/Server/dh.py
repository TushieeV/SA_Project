...
class DiffieHellman:
    ...
    @staticmethod
    def is_valid_public_key_static(local_private_key_str: str, remote_public_key_str: str, prime: int) -> bool:
...
if __name__ == '__main__':
    if len(sys.argv) > 1 and sys.argv[1] == 'shared':
        print(DiffieHellman.generate_shared_key(sys.argv[2], sys.argv[3]))
    else:
        user = DiffieHellman()
        print(user.get_private_key())
        print(user.generate_public_key())
